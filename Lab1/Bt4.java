...
public class Bt4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Tong cac so nguyen to la "+ IntStream.of(arrayRandom).filter(Bt4::isSNT).sum());
        ...
        System.out.println("So nguyen to nho nhat "+ (IntStream.of(arrayRandom).filter(Bt4::isSNT).min().orElse(-1)));
        int[] arraySntSorted = IntStream.of(arrayRandom).filter(Bt4::isSNT).sorted().toArray();
